...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 17, fontWeight: '800', letterSpacing: -0.3, color: '#fff' },
  locRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  loc: { color: 'rgba(255,255,255,0.88)', fontSize: 12, fontWeight: '500' },
  yaptirim: {
    flexDirection: 'row',
    gap: 11,
    padding: 13,
  ...
  trustTitle: { fontSize: 14.5, fontWeight: '800', color: colors.onSurface },
  trustText: { fontSize: 12, color: colors.onSurfaceVariant, lineHeight: 17, fontWeight: '500', marginTop: 4 },
  ...
  statValue: { fontSize: 18.5, fontWeight: '800', letterSpacing: -0.4, color: colors.onSurface },
  statLabel: { fontSize: 10, color: colors.onSurfaceVariant, fontWeight: '700', marginTop: 3, textAlign: 'center' },
  ...
  accTitle: { fontSize: 14, fontWeight: '800', color: colors.onSurface },
  accSub: { fontSize: 11.5, color: colors.onSurfaceVariant, fontWeight: '500', marginTop: 2 },
  ...
  secTitle: { fontSize: 18, fontWeight: '800', color: colors.onSurface },
  ...
  st: { flex: 1, fontSize: 14, fontWeight: '800', color: colors.onSurface },
